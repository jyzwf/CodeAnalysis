            ...
            columns: [
                ...
                {title: '备注', dataIndex: 'remark', key: 'remark', width: '6%'},
                {
                    ...
                    render: (text, record) => {
                        ...
                        let _this = this;
                        let {_isAuthZed} = this.state
                        //let passDealerInfoHtml = <a onClick={() => _this.passDealerInfo(dealerId)}>通过 </a>;
                        let passDealerInfoHtml = null,
                            editDealerInfoHtml=null,
                            deleteDealerInfoHtml=null,
                            viewDealerInfoHtml=null

                        if(_isAuthZed){
                            if (this.authZInfo.hasResAccess("FCL-DEALER-FIRSTAUDIT-PASS")) {
                                passDealerInfoHtml = (<a onClick={() => _this.passDealerInfo(dealerId)}>通过 </a>);
                            }

                            if (this.authZInfo.hasResAccess("FCL-DEALER-FIRSTAUDIT-EDIT")) {
                                editDealerInfoHtml = (<a onClick={() => { _this.editDealer(dealerId) }}>修改 </a>);
                            }

                            if (this.authZInfo.hasResAccess("FCL-DEALER-FIRSTAUDIT-DELETE")) {
                                deleteDealerInfoHtml = (<a onClick={() => _this.deleteDealerInfo(dealerId)}>删除 </a>);
                            }

                            if (this.authZInfo.hasResAccess("FCL-DEALER-FIRSTAUDIT-VIEW")) {
                                viewDealerInfoHtml = (<a onClick={() => { _this.viewDealer(dealerId) }}>查看</a>);
                            }
                        }
                                ...
                                <Col span={4}>
                                    <FormItem style={{width: '100%', textAlign: "right"}}>
                                        ...
                                        <Row >
                                            {
                                                _isAuthZed&&
                                                this.authZInfo.hasResAccess("FCL-DEALER-FIRSTAUDIT-ADD")&&
                                        ...
                                        <Row style={{width: '100%'}}>
                                            {
                                                _isAuthZed&&
                                                this.authZInfo.hasResAccess("FCL-DEALER-FIRSTAUDIT-EXPORT")&&
                                                (<Button type="primary" style={{marginRight: 5}} onClick={_this.exportDealerFirst}>导出</Button>)
                                            }

                                            {
                                                _isAuthZed&&
                                                this.authZInfo.hasResAccess("FCL-DEALER-FIRSTAUDIT-IMPORT")&&
