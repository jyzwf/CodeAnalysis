  ...
  */
  Vue.extend = function (extendOptions: Object): Function {
    ...
    */
    ...
    /*创建一个新的cid*/
    Sub.cid = cid++
    /*将父组件的option与子组件的合并到一起(Vue有一个cid为0的基类，即Vue本身，会将一些默认初始化的options混入)*/
    Sub.options = mergeOptions(
      Super.options,
      extendOptions
    )
    /*es6语法，super为父类构造*/
    // 这里为 init.js 里的 resolveConstructorOptions 函数做了准备
    Sub['super'] = Super

    // For props and computed properties, we define the proxy getters on
    // the Vue instances at extension time, on the extended prototype. This
    // avoids Object.defineProperty calls for each instance created.
    /*在扩展时，我们将计算属性以及props通过代理绑定在Vue实例上，这也避免了Object.defineProperty被每一个实例调用*/
    if (Sub.options.props) {
      // 将子类的 options.props 代理到 子类的原型上，这样每次实例化子类时，就不需要重复调用 Object.defineProperty
      initProps(Sub)
    }
    ...
    /*保存一份定义时的options，extend的作用是将Sub.options中的所有属性放入{}中*/
