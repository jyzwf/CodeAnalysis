 ...
 *      attrs,  // create，update
        ...
        domProps, // create，update
        style,  // create，update
        transition, // create，activate，remove
        ref,  // create，update，destory
        directives  // create，update，destory
 * ]
 */
  ...
  function createElm(vnode, insertedVnodeQueue, parentElm, refElm, nested) {
    ...
    const children = vnoden = vnode.children
    const tag = vnode.tag
    if (isDef(tag)) {
      ...
      vnode.elm = vnode.ns ?
        ...
        nodeOps.createElement(tag, vnode)   // 创建一个真实的元素
  ...
  function patchVnode(oldVnode, vnode, insertedVnodeQueue, removeOnly) {
    ...
    */
    ...
    if (isDef(data) && isDef(i = data.hook) && isDef(i = i.prepatch)) {
      /*i = data.hook.prepatch，如果存在prepatch，如果存在的话，见"./create-component componentVNodeHooks"。*/
      i(oldVnode, vnode)
    }
    ...
    if (isUndef(oldVnode)) {
      ...
      if (!isRealElement && sameVnode(oldVnode, vnode)) {
        ...
        if (isDef(vnode.parent)) {
          ...
          /*组件根节点被替换，遍历更新父节点被替换，遍历更新父节点element*/
          // ？？？？？？？？？？？？？
